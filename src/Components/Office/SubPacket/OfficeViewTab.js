...
export class SubPacketIndex extends Component {
   ...
   getOfficeSubList = (value)=>{
     console.log('resresresresres', value)
    this.props
    .getOfficeSubList(value)
    .then((res) =>
    ...
    closeSubPacket = () => {
      this.props.history.push("/office-work")
      // this.setState({
      //   subPacketModel: false
      // })
    }
    ...
    edit = (data) => {
      ...
      .then((res) => {
        ...
        const preSelectData = res.data.find((value) => value._id === data.office_id)
    ...
    render() {
        ...
        const subPacket =[
          ...
          console.log('subPacketsubPacketsubPacket', subPacket,this.state.subPacketData)
...
export default connect(null, { getOfficeList, getOfficeSubList, getRoughPrefrence }) (SubPacketIndex);